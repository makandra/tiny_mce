	...
	tinymce.create('tinymce.plugins.SpellcheckerPlugin', {
		...
		_getWords : function() {
			...
			if (ed.getParam('spellchecker_word_pattern')) {
				...
				rawWords = tx.match(new RegExp('(' + ed.getParam('spellchecker_word_pattern') + ')', 'gi'));
			} else {
      ...
      var b;
      // Getting bookmarks when the form is submitted fails in IE8 
      try { b = se.getBookmark(); } catch(e) { b = null; }
